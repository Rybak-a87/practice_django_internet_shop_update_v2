...
class CategoryFeature(models.Model):
    ...
    """
    category = models.ForeignKey("mainapp.Category", verbose_name="Категория", on_delete=models.CASCADE)    # образец ссылки на объект другого приложения
    ...
    # чтобы характеристики не дублировались
    class Meta:
        unique_together = (    # уникальность
            "category",
            "feature_name",
            "feature_filter_name"
        )
